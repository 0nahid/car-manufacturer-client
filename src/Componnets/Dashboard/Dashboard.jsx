  ...
  return (
    <div className="drawer">
      ...
      <div className="drawer-content flex flex-col">
        <div className="w-full navbar z-50 sticky top-0 bg-base-300">
          ...
          <div className="flex-none hidden lg:block">
            <ul className="menu menu-horizontal">{Navmenu}</ul>
          </div>
          <div className="right-1 lg:right-10 absolute">
            <NavLink
              to="/"
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 overflow-y-auto w-80 bg-base-100">{Navmenu}</ul>
      </div>
    </div>
  );
}
