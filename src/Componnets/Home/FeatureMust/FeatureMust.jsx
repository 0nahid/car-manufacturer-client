  ...
  return (
    <>
      <div className="text-center mt-32">
        ...
        <p className="font-bold text-neutral m-5">
          Enjoy an entirely new level of driving experience with our in-depth
          selection of superior car bulbs, brake pads, spark plugs, and other
          automotive parts and accessories designed to keep your car running at
          its absolute best.
        </p>
      </div>
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 justify-items-center px-5 md:px-0">
        {services.map((service) => (
          <FeatureMustData key={service._id} service={service} />
        ))}
      </div>
    </>
  );
